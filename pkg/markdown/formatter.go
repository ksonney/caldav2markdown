...
// OutputLocation is the time zone used when rendering event/task times into
// output files. It defaults to the system's local time zone; use
// SetOutputLocation to override it (e.g. from the -timezone flag or
// OUTPUT_TIMEZONE config option).
var OutputLocation = time.Local

// SetOutputLocation sets the time zone used to render times in generated output.
...
func getWeekBounds(year, week int) (time.Time, time.Time) {
	...
	jan4 := time.Date(year, time.January, 4, 0, 0, 0, 0, OutputLocation)
